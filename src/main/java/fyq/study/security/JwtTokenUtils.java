...
public class JwtTokenUtils {
     ...
     * 密钥
     */
    private static final String SECRET = GeneralConstant.SECRET;
    /**
     * 有效期48小时
     */
    private static final long EXPIRE_TIME = GeneralConstant.TIME_48_HOURS;
        ...
        if(token != null){
            ...
            if(SecurityUtils.getAuthentication() == null){
                ...
                if(validateToken(token,SecurityUtils.getUserName())){
                    //如果上下文中的authentication非空，且请求令牌合法，直接返回当前登录认证信息
    ...
    public static String getToken(HttpServletRequest request){
        ...
        String tokenHead = GeneralConstant.TOKEN;
        if(token==null){
